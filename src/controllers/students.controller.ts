...
export class StudentsController {
  ...
  @post('/students/FindFilter')
  // @get('/students/FindByname/{section}')
  ...
  async findByname_section(
    ...
    return this.studentsRepository.find({where : {name: students.name,section:students.section}});
  }
